...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        for s in splits:
            if len(s) <= self.chunk_size:
                ...
                if good_splits:
                    final_chunks.extend(self._combine_splits(good_splits, separator))
                    good_splits = []
    ...
    def _combine_splits(self, splits: list[str], separator: str) -> list[str]:
        docs: list[str] = []
        ...
        for s in splits:
            ...
            if total + sep_len + len_s <= self.chunk_size:
